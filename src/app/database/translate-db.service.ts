...
export class TranslateDbService extends DbServiceRepositoryBase<Translate> {
  data: Translate[] = [
    ...
    } /* --------------------- */,
    {
      ...
      value:
        "Allent Plastik Kalıp Sanayi Ticaret Limited Şirketi, 2019 yılında Konya' da Mak. Müh. Bülent Dağ tarafından kurulmuştur.",
    },
    {
      id: 14,
      languageId: 2,
      key: 'footerDescriptionFromDb',
      value:
        'Allent Plastic Mold Industry Trade Limited Company, in 2019 in Konya, Mak. Eng. It was established by Bülent Dağ.',
    } /* --------------------- */,
    {
      id: 3,
      languageId: 1,
    ...
    } /* --------------------- */,
    {
      ...
      languageId: 1,
      key: 'footerBrand',
      value: 'ALLENT Plastik Kalıp',
    },
    {
      id: 14,
      languageId: 2,
      key: 'footerBrand',
      value: 'ALLENT Plastic Mold',
    } /* --------------------- */,
    {
      id: 3,
      languageId: 1,
